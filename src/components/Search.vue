  ...
  <div class="movies">
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          <ul>
            <li v-for="(movie,key) in movies" class="boxMovie" :class="'m'+key" @click='detailMovie(movie.id)'>
              <div class="boxImg">
	...
	data () {
  	...
  	methods: {
  		getInfos () {
	  		...
	  		let url = 'https://api.themoviedb.org/3/search/movie?api_key=' + this.apiKey + '&language=pt-BR&query=' + this.query + '&page=' + this.currentPage + '&include_adult=true';
	  		let t = this;
	  		axios.get(url)
